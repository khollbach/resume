...
\item {\sffamily \href{https://github.com/khollbach/apple-ii-audio/}{bas2wav}}: Rust tool to convert Applesoft BASIC source code into .wav audio \\[-2pt]
\item {\sffamily \href{https://github.com/khollbach/chip-8/}{CHIP-8}}: retro video game system emulator, written in Rust
\end{itemize}
